...
#define  VERSION_99     "2026-01-11 rcc_module11"
...
#define  TOPIC_BASE     "rcc/module11"
...
#define  SCREEN_TITLE   "RCC Module 11"
...
#define  RCOMP_1        RC_TYPE_TO,"W1", 111, EX0,PIN0,PIN1, EX1,PIN0,PIN1, 500,0
//-------disconnectable track (Fahrstrom)-----------------------
#define  RCOMP_2        RC_TYPE_DT,"G1", 112, EX0,PIN2,NO_PIN, EX1,PIN2,NO_PIN, 0,0
// ------uncoupler (Entkuppler)---------------------------------
#define  RCOMP_3        RC_TYPE_UC,"E1", 113, EX0,PIN3,NO_PIN, EX1,PIN3,NO_PIN, 1500,0
