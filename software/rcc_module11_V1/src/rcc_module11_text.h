//_____rcc_module11_text.h_______________________khartinger_____
// define text in English and German
#ifndef rcc_module11_TEXT_H
 #define rcc_module11_TEXT_H
...
#define  INFOLINES { \
  ...
  VERSION_99_1, \
  " Next: Button IO19   ", \
  "DCC 111 2-Way-Turnout", \
  "DCC 112  Discon Track", \
  "DCC 112: Uncoupler   ", \
  "DCC 113: Entkuppler  ", \
  "                     ", \
  " Next: Button IO19   ", \
