...
#define  VERSION_99     "2026-01-12 rcc_module10"
#define  VERSION_99_1   "Version 2026-01-12"
...
#define  TOPIC_BASE     "rcc/module10"
...
#define  SCREEN_TITLE   "RCC Module 10"
...
PCF8574 *pIOEx[IOEX_NUM]={&pcf8574_0, &pcf8574_1,
                          &pcf8574_2, &pcf8574_3}; // IO expander
...
#define  RCOMP_1L       RC_TYPE_T3,"T1L",101, EX0,PIN0,PIN1, EX1,PIN0,PIN1, 500,0
#define  RCOMP_1R       RC_TYPE_T3,"T1R",102, EX0,PIN2,PIN1, EX1,PIN2,PIN1, 500,0
//-------three way turnout (Dreiwegweiche)----------------------
// A=0: curved, B=0: stright (@ 3 pin: middle pin=0V -> stright)
#define  RCOMP_2L       RC_TYPE_T3,"T2L",103, EX0,PIN3,PIN4, EX1,PIN3,PIN4, 500,0
#define  RCOMP_2R       RC_TYPE_T3,"T2R",104, EX0,PIN5,PIN4, EX1,PIN5,PIN4, 500,0
...
#define  RCOMP_3        RC_TYPE_TO,"T3", 105, EX0,PIN6,PIN7, EX1,PIN6,PIN7, 500,0
//-------disconnectable track (Fahrstrom)-----------------------
#define  RCOMP_4        RC_TYPE_DT,"DRS",106, EX2,PIN0,NO_PIN, EX3,PIN0,NO_PIN, 0,0
//-------disconnectable track (Fahrstrom)-----------------------
#define  RCOMP_5        RC_TYPE_DT,"DLS",107, EX2,PIN1,NO_PIN, EX3,PIN1,NO_PIN, 0,0
// ------uncoupler (Entkuppler)---------------------------------
#define  RCOMP_6        RC_TYPE_UC,"UC", 108, EX2,PIN2,NO_PIN, EX3,PIN2,NO_PIN, 1500,0

//.......Array of all railway components........................
#define  RCOMP_NUM      8
strRcomp aRcomp[RCOMP_NUM] = {
 RCOMP_1L, RCOMP_1R, RCOMP_2L, RCOMP_2R, RCOMP_3, RCOMP_4, RCOMP_5, RCOMP_6
};
#endif