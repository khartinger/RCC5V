...
| Zeile   | Chg | Bedeutung |   
|:-------:|:---:|-----------|   
| 19, 20  |  2  | Versionsnummer/&Auml;nderungsdatum der Datei. |   
| 22      |  3  | Anzahl Sekunden, wie lange jede Info-Seite beim Start angezeigt werden soll (zB 20 Sekunden). |   
| 25      |  2  | Soll ein Netzwerk (WLAN) verwendet werden? <br> true = ja, false = nein |   
| 26 - 28 |  2  | Wenn ein Netzwerk verwendet wird: Name und Passwort des WLAN sowie IP des Rechners, auf dem der MQTT-Broker l&auml;uft. |   
| 29      | __1__ | Das Basis-Topic, unter dem der Mikrocontroller MQTT-Nachrichten sendet oder empf&auml;ngt. |   
| 30      |  x  | Alle GET-Nachrichten, auf die der Mikrocontroller antwortet. |   
| 31      |  x  | Alle SET-Nachrichten, auf die der Mikrocontroller reagiert. |   
| 36      |  2  | Titel auf der OLED-Anzeige. |   
| 41      |  3  | Offset der DCC-Adressen, je nach DCC-Sendeger&auml;t (Wert kann 4 oder 0 sein). |   
| 44      | __1__ | Anzahl der eingesetzten I²C-I/O-Expander-Boards PCF8574 (2, 4, 6 oder 8).   |   
| 45 - 46 |  2  | Je ein Objekt f&uuml;r jedes PCF8574-Board mit I²C-Busnummer (1), 7-Bit-I²C-Adresse (0x20, ...) und Startwert (meist 0xFF). |   
| 47      | __1__ | `*pIOEx[]` = Pointer-Array mit den Adressen der PCF8574-Board-Objekten (nicht auf das &-Zeichen vor den Namen vergessen!). |   
| 49 - 74 |  x  | Definitionen f&uuml;r die Eisenbahn-Komponenten. Sie befinden sich nur zum An- bzw. Nachschauen in dieser Datei. |   
| 76 - 101 | __1__ | Definition von Strukturen f&uuml;r jede einzelne Eisenbahn-Komponente. Der Aufbau jeder Zeile entspricht der Struktur von Zeile 58 bis 70.   |   
| 104     | __1__ | Anzahl der Eisenbahn-Komponenten. |   
| 105 - 107 | __1__ | `aRcomp[]` = Array mit den Strukturen der einzelnen Eisenbahn-Komponenten. |   
