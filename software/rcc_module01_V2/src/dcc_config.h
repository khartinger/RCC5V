...
// 2026-03-26 Module01 Version 2026
...
#define  VERSION_99     "2026-03-26 rcc_module01 - 2026"
#define  VERSION_99_1   "Version 2026-03-26 2026"
...
#define  RCOMP_1        RC_TYPE_TO,"T1", 11, EX0,PIN0,PIN1,   EX1,PIN0,PIN1, 500,0
// ------two way turnout (Zweiwegweiche = Standardweiche)-------
// Two expander pins A B to control 2way turnout (active low!)
// A=0: curved, B=0: stright
#define  RCOMP_2        RC_TYPE_TO,"T2", 12, EX0,PIN2,PIN3,   EX1,PIN2,PIN3, 500,0
//-------disconnectable track (Fahrstrom)-----------------------
#define  RCOMP_3        RC_TYPE_DT,"DT", 13, EX0,PIN4,NO_PIN, EX1,PIN4,NO_PIN, 0,0

//.......Array of all railway components........................
#define  RCOMP_NUM      3
strRcomp aRcomp[RCOMP_NUM] = {
 {RCOMP_1},{RCOMP_2},{RCOMP_3}
};
#endif