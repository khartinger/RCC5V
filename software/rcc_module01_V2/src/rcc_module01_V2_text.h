//_____rcc_module01_V2_text.h____________________khartinger_____
...
// "---------|---------|-" line length = 21
  ...
  #define  INFOLINES { \
   ...
   "DCC 11 Weiche Hauptgl", \
   "DCC 12 Weiche Ladegle", \
   VERSION_99_1, \
   " Weiter: Taste IO19  ", \
   "DCC 13 Fahrstrom 1/0 ", \
   " ",\
...
// "---------|---------|-" line length = 21
  ...
  #define  INFOLINES { \
   ...
   "DCC 11 Turnout main   ", \
   "DCC 12 Turnout loading", \
   VERSION_99_1, \
   " Next: Button IO19   ", \
   "DCC 13 Disconn. Track", \
   " ",\
   "Next up: IO-Expander ", \
   " and Wifi search     ", \
   " Next: Button IO19   ", \
