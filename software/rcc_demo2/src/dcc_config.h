...
#define  VERSION_99     "2026-08-11 rcc_demo2"
#define  VERSION_99_1   "Version 2026-08-11"
...
PCF8574  pcf8574_out2(1,0x22,0xFF);    // 8 digital OUT
PCF8574  pcf8574_in2 (1,0x23,0xFF);    // 8 digital IN
PCF8574 *pIOEx[IOEX_NUM]={&pcf8574_out, &pcf8574_in, &pcf8574_out2, &pcf8574_in2}; // IO expander
...
#define  RC_TYPE_P2     7    // pulse 2 inputs (reset, set)
...
strRcomp aRcomp[RCOMP_NUM] = {
 {RCOMP_1},{RCOMP_2},{RCOMP_3L},{RCOMP_3R},{RCOMP_4},{RCOMP_5},{RCOMP_6}
};
*/
