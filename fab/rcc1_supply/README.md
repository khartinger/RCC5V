...
3. plugging and unplugging the 5V power supply board into J5 and J6 <br> Tip: It is much easier to plug in the power supply board if you shorten the upper pin header slightly so that the pins can be inserted one after the other...   
...
2. plugging and unplugging the 5V power supply board into J5 and J6 <br> Tip: It is much easier to plug in the power supply board if you shorten the upper pin header slightly so that the pins can be inserted one after the other...   
