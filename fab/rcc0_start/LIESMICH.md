...
# Einleitung
Wenn ich mich dazu entschlossen habe, selbst die Steuerung f&uuml;r meine Modellbahn-Komponenten zu bauen, ist dazu etwas Zeit und Geld erforderlich. Es m&uuml;ssen sowohl Hardware- als auch Software-Voraussetzungen geschaffen werden.   
### Hardware
F&uuml;r den Bau der RCC-Komponenten sind [Leiterplatten](#x20) und eine Art ["Grundausstattung an Bauteilen"](#x30) erforderlich. Wie man dazu kommt, ist weiter unten beschrieben.   
### Software
An Software wird das Open Source [Layoutprogramm KiCad](https://www.kicad.org/) mit dem Plug-in "PCBWay" und Visual Studio Code mit dem Plugin "PlatformIO" ben&ouml;tigt.   
Mit Hilfe von KiCad k&ouml;nnen die Leiterplatten-Layouts an eigene Bed&uuml;rfnisse angepasst bzw. einfach durch professionelle Leiterplattenhersteller wie zB die Firma PCBWay hergestellt werden.   
Visual Studio Code ist erforderlich, um die Steuersoftware an die eigenen Bed&uuml;rfnisse anzupassen und auf den ESP32 zu laden.   

[Zum Seitenanfang](#up)   
<a name="x20"></a>   

# Leiterplatten f&uuml;r RCC-Komponenten   
## Welche Leiterplatten ben&ouml;tige ich?
Welche Leiterplatten man ben&ouml;tigt, ist naturgem&auml;&szlig; abh&auml;ngig vom Anwendungsfall. Einige Platinen ben&ouml;tigt man aber auf jeden Fall.   

### Immer erforderliche Platinen
Immer erforderlich sind die beiden Shields f&uuml;r den ESP32   
...
Die Hilfsplatinen zum Anschlie&szlig;en der Weiche(n) und der Ein- und Ausg&auml;nge der PCF8574 sind praktisch, k&ouml;nnten aber auch durch das direkte Anstecken der Leitungen an den Bl&ouml;cken umgangen werden.
* [/fab/kicad/CON_10pol_PIN_V2](/fab/kicad/CON_10pol_PIN_V2)   
* [/fab/kicad/CON_6pol_3_V1](/fab/kicad/CON_6pol_3_V1) f&uuml;r Zwei-Weg-Weiche   
* [/fab/kicad/CON_6pol_6_V1](/fab/kicad/CON_6pol_6_V1) f&uuml;r Drei-Weg-Weiche   

### Strom- bzw. Modulversorgung
Hier unterscheidet man,   
* ob die Versorgung &uuml;ber ein 25-poliges Kabel erfolgt oder nicht und   
* wie lange das Modul ist.   

F&uuml;r kurze Module (bis 50 cm) mit 25-poligem Kabel:
* [/fab/kicad/RW_5V_2SUB25_V2](/fab/kicad/RW_5V_2SUB25_V2)   

F&uuml;r lange Module (l&auml;nger als 50 cm) mit 25-poligem Kabel:
...
### Leiterplatten f&uuml;r RCC-Bl&ouml;cke
RCC-Bl&ouml;cke bestehen immer aus zwei Platinen: eine f&uuml;r die Steuerung (STRG) und eine f&uuml;r die Taster, Schalter und LED-Anzeige (LED).   

M&ouml;chte man __Zwei-Weg-Weichen__ schalten, so ben&ouml;tigt man die Platinen   
* [/fab/kicad/RW_5V_W2_STRG_V2](/fab/kicad/RW_5V_W2_STRG_V2)   
* [/fab/kicad/RW_5V_W2_LED_V2](/fab/kicad/RW_5V_W2_LED_V2)   

M&ouml;chte man __Drei-Weg-Weichen__ schalten, so ben&ouml;tigt man die Platinen   
* [/fab/kicad/RW_5V_W3_STRG_V4](/fab/kicad/RW_5V_W3_STRG_V4)   
* [/fab/kicad/RW_5V_W3_LED_V4](/fab/kicad/RW_5V_W3_LED_V4)   

M&ouml;chte man Gleise ein- und abschalten, so ben&ouml;tigt man die Platinen   
* [/fab/kicad/RW_5V_2IO_STRG_V1](/fab/kicad/RW_5V_2IO_STRG_V1)   
* [/fab/kicad/RW_5V_2IO_LED_V2](/fab/kicad/RW_5V_2IO_LED_V2)   

M&ouml;chte man Entkuppler betreiben, so ben&ouml;tigt man die Platinen   
...
3. Mausklick auf das Icon PCBWay: Es werden die Leiterplatten-Daten an [https://www.pcbway.com](https://www.pcbway.com) geschickt und die Webseite der Firma &ouml;ffnet sich im Browser.   
4. Nach kurzer Zeit werden im Browser die Vorder- und R&uuml;ckseite der Leiterplatte angezeigt. Da die Kosten f&uuml;r 5 oder 10 St&uuml;ck derzeit (Dezember 2024) gleich sind, sollte man bei "Quantity (single):" die St&uuml;ckzahl auf 10 pcs ausbessern.   
5. Durch Anklicken der Schaltfl&auml;che "Save to cart" werden die Daten in den Warenkorb &uuml;bertragen und durch die Firma PCBWay automatisch &uuml;berpr&uuml;ft.   
6. Das KiCad-Projekt kann jetzt geschlossen werden und das n&auml;chste Projekt gestartet werden. Diese Schritte wiederholt man so lange, bis sich die Daten aller Leiterplatten im Warenkorb der Firma PCBWay befinden.   
7. Sind alle Leiterplatten &uuml;berpr&uuml;ft, w&auml;hlt man die Versandart und bezahlt die Ware. Hat man es eilig, kann man als Transportunternehmen "DHL Express" w&auml;hlen, das ist zwar nicht sehr billig aber schnell, zuverl&auml;ssig und die Paketverfolgung ist super.   

[Zum Seitenanfang](#up)   
<a name="x30"></a>   

# Grundausstattung an Bauteilen   
F&uuml;r die Herstellung der RCC-Komponenten werden sowohl mechanische als auch elektronische Bauteile ben&ouml;tigt. Im folgenden werden vor allem Links zu Amazon und AliExpress angef&uuml;hrt, obwohl es gerade bei diesen Verkaufsplattformen des &ouml;fteren vorkommt, dass die angef&uuml;hrten Seiten von Lieferanten nach einiger Zeit oft nicht mehr verf&uuml;gbar sind.   
Viele der Bauteile, wie zB Schrauben, werden in gr&ouml;&szlig;eren Gebinden verkauft, hier reicht es meist, eine Packung zu kaufen.   
Die unten angegebenen Mengen reichen f&uuml;r den Bau _eines_ Moduls mit mehreren Bl&ouml;cken.   
Die angegebenen Preise dienen nur der Information und waren im Dezember 2024 g&uuml;ltig (ohne Black Friday etc.).   

<a name="x31"></a>   
## Mechanische Bauteile

| Bild | Anzahl | St&uuml;ck /Pkg | Bezeichnung | ca. Euro | Quelle |   
|:---- |:------:|:----------:|:----------- | --------:|:------ |   
...
| ![PCB_Screw_Connector_2P](/images/parts/300_PCB_Screw_Connector_2P.png "PCB_Screw_Connector_2P") | 1 | 50 | Schraubklemmen f&uuml;r Leiterplatte, 2-polig, schwarz oder blau, 5,0 mm | 12,36 |[AliExpress](https://de.aliexpress.com/item/1005007145396958.html?spm=a2g0o.order_list.order_list_main.102.f9f35c5fko3NNE&gatewayAdapt=glo2deu) |   
| ![PCB_Screw_Connector_3P](/images/parts/300_PCB_Screw_Connector_3P.png "PCB_Screw_Connector_3P") | 1 | 50 <br> 30 | Schraubklemmen f&uuml;r Leiterplatte, 3-polig, schwarz oder blau, 5,0 mm |   15,16 <br> 7,04 |[AliExpress](https://de.aliexpress.com/item/1005007145396958.html?spm=a2g0o.order_list.order_list_main.102.f9f35c5fko3NNE&gatewayAdapt=glo2deu) <br> [Amazon](https://www.amazon.de/dp/B071GMT7ZZ?ref=ppx_yo2ov_dt_b_fed_asin_title) |   
...
| ![socket_ribbon_cablec_connector_6pol](/images/parts/300_socket_ribbon_cablec_connector_6a.png "socket_ribbon_cablec_connector_6pol") | 2 | 10 | IDC Buchsen-Stecker f&uuml;r Flachbandkabel 6-polig | 2,98 | [AliExpress](https://de.aliexpress.com/item/1005002804645942.html?spm=a2g0o.order_list.order_list_main.165.f9f35c5fKqYn54&gatewayAdapt=glo2deu) |   
| ![socket_ribbon_cablec_connector_10pol](/images/parts/300_socket_ribbon_cablec_connector_10.png "socket_ribbon_cablec_connector_10pol") | 1 | 10 | IDC Buchsen-Stecker f&uuml;r Flachbandkabel 10-polig | 2,86 | [AliExpress](https://de.aliexpress.com/item/1005002804645942.html?spm=a2g0o.order_list.order_list_main.165.f9f35c5fKqYn54&gatewayAdapt=glo2deu) |   
...
| Bild | Anzahl | St&uuml;ck /Pkg | Bezeichnung | ca. Euro /Pkg | Quelle |   
|:---- |:------:|:----------:|:----------- | --------:|:------ |   
...
| ![OLED 1,54"](/images/parts/200_oled154.png "OLED 1,54") | 1 | 1 | OLED-Display 1,54 Zoll, I2C __4 Pin__ wei&szlig; | 4,34 <br> 8,68 | [AliExpress](https://de.aliexpress.com/item/1005006193834348.html?spm=a2g0o.order_list.order_list_main.84.f9f35c5fI5TZhl&gatewayAdapt=glo2deu) <br> [AliExpress](https://de.aliexpress.com/item/1005005901019407.html?spm=a2g0o.order_list.order_list_main.48.f9f35c5fI5TZhl&gatewayAdapt=glo2deu) |   
...
| ![LED red](/images/parts/200_LED_rot.png "LED red") | 10 | 1 | LED rot 3mm, 2mA | 0,151 | [Reichelt](https://www.reichelt.com/at/de/shop/led-3-mm-bedrahtet-rot-5-mcd-60--led-3mm-2ma-rt-p21626.html?&nbc=1) |   
| ![LED yellow](/images/parts/200_LED_gelb.png "LED yellow") | 30 | 1 | LED gelb 3mm, 2mA | 0,151 | [Reichelt](https://www.reichelt.com/at/de/shop/produkt/led_3_mm_bedrahtet_gelb_3_2_mcd_60_-21628) |   
| ![LED green](/images/parts/200_LED_gruen.png "LED green") | 20 | 1 | LED gr&uuml;n 3mm, 2mA | 0,151 | [Reichelt](https://www.reichelt.com/at/de/shop/produkt/led_3_mm_bedrahtet_gruen_3_2_mcd_60_-21624) |   
...
| ![BC327-40](/images/parts/300_BC327-40.png "BC327-40") | 20 | 1 | Transistor BC327-40 PNP | 0,04 | [Reichelt](https://www.reichelt.at/at/de/shop/produkt/bipolartransistor_pnp_45v_0_5a_0_625w_to-92-219124) |   
| ![BC337-40](/images/parts/300_BC337-40.png "BC337-40") | 20 | 1 | Transistor BC337-40 NPN | 0,04 | [Reichelt](https://www.reichelt.at/at/de/shop/produkt/bipolartransistor_npn_45v_0_8a_0_625w_to-92-219126) |   
...
| ![100nF_5mm](/images/parts/300_100nF_5mm.png "100nF_5mm") | 1 | 40 | Kondensator 100 nF, 5,08 mm | 2,12 | [AliExpress](https://de.aliexpress.com/item/32904550088.html?spm=a2g0o.order_list.order_list_main.366.f9f35c5fzFZWFA&gatewayAdapt=glo2deu) |   
| ![100nF](/images/parts/300_100nF.png "100nF") | 1 | 10 <br> 50 | Kondensator 100 nF, 50 V, 2,54 mm (Vielschicht-Kerko)| 0,65 <br> 2,07| [Reichelt](https://www.reichelt.at/at/de/shop/produkt/vielschicht-kerko_100nf_50v_125_c-206877) <br> [AliExpress](https://de.aliexpress.com/item/32865098104.html?spm=a2g0o.order_list.order_list_main.46.f9f35c5fzFZWFA&gatewayAdapt=glo2deu) |   
| ![10nF](/images/parts/300_10nF.png "10nF") | 50 <br> 1 | 1 <br> 50 | Kondensator 10 nF | 0,24 <br> 2,06 | [Reichelt](https://www.reichelt.at/at/de/shop/produkt/keramik-kondensator_10_nf_0_v_20_85_c-246906) <br> [AliExpress](https://de.aliexpress.com/item/32865098104.html?spm=a2g0o.order_list.order_list_main.46.f9f35c5fzFZWFA&gatewayAdapt=glo2deu) |   
| ![1nF](/images/parts/300_1nF.png "1nF") | 1 | 50 | Kondensator 1 nF, 2,54 mm| 2,16 | [AliExpress](https://de.aliexpress.com/item/32865098104.html?spm=a2g0o.order_list.order_list_main.46.f9f35c5fzFZWFA&gatewayAdapt=glo2deu) |   
...
| Bild | Anzahl | St&uuml;ck /Pkg | Bezeichnung | ca. Euro | Quelle |   
|:---- |:------:|:----------:|:----------- | --------:|:------ |   
| ![solder wire](/images/parts/300_solderwire1.png "solder wire ")  | 1 | 1 | L&ouml;tzinn, Bleifreies Lot mit Kolophonium Kern (Sn99 Ag0,3 Cu0,7/0,8mm,50g) | 11,09 | [Amazon](https://www.amazon.de/dp/B07Z7JQ4SX?ref=ppx_yo2ov_dt_b_fed_asin_title) |   
...
| ![](/images/parts/) | 1 | 40 | Dupont Line 10 cm, 40 Pin, Buchse auf Buchse (F-F 10cm 40pin), "Female-Female Jumper Wires" | 2,41 | [AliExpress](https://de.aliexpress.com/item/1005003641187997.html?spm=a2g0o.order_list.order_list_main.509.40f55c5f5h69eX&gatewayAdapt=glo2deu) |   
...
L&ouml;tstation, kleine Spitzzange, kleiner Seitenschneider, kleiner Schraubendreher, Abbrechklingenmesser ("Stanley-Messer", Cutter-Messer), Schraubstock.   
Bohrmaschine, Laubs&auml;ge, Bohrer (5,6 mm, 8 mm, 11,6 mm).   

# Fertigen der Komponenten
Hat man - nach einiger Wartezeit - sowohl die Leiterplatten als auch die Bauteile zur Verf&uuml;gung, geht es an das Herstellen der Komponenten. Das ist auf folgenden Seiten beschrieben:   
* [Komponenten f&uuml;r die Stromversorgung: `/fab/rcc1_supply/LIESMICH.md`](/fab/rcc1_supply/LIESMICH.md)   
* [Erweiterungen (Shields) f&uuml;r den ESP32: `/fab/rcc2_esp32/LIESMICH.md`](/fab/rcc2_esp32/LIESMICH.md)   
